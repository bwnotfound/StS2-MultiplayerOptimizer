...
internal static class SettingsUiInjectionPatch
{
    ...
    private static void InjectRows(NSettingsScreen screen)
    {
    ...
    private static void RefreshSliderRow(Control row)
    {
        ...
        var currentInternal = MultiplayerOptimizerConfig.SpeedMultiplier * InternalToDisplay;
        ...
        MainFile.Logger.Info(
            $"[Slider] Setting value to {currentInternal} (config.SpeedMultiplier={MultiplayerOptimizerConfig.SpeedMultiplier})");
        ...
        MainFile.Logger.Info(
            $"[Slider] Final state: slider.Value={slider.Value}, config.SpeedMultiplier={MultiplayerOptimizerConfig.SpeedMultiplier}");
    }
    ...
    private static void OnSpeedSliderValueChanged(double internalValue)
    {
        try
        {
            ...
            MultiplayerOptimizerConfig.SpeedMultiplier = multiplier;
