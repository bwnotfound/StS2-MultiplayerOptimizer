...
///     本地 NotEnoughDifficultyConfig 字段已经被 host 配置覆盖，
...
///     1. <b>必须先判断 __instance is NotEnoughDifficultyConfig</b>。不是我们的 config 直接
...
public static class WeightNormalizationPatch
{
    ...
    private static readonly PropertyInfo[]? Act4EncProps = LoadPropsOrNull(
        nameof(NotEnoughDifficultyConfig.Act4_EncWeight_Act1),
        nameof(NotEnoughDifficultyConfig.Act4_EncWeight_Act2),
        nameof(NotEnoughDifficultyConfig.Act4_EncWeight_Act3));

    private static readonly PropertyInfo[]? Act4EventProps = LoadPropsOrNull(
        nameof(NotEnoughDifficultyConfig.Act4_EventWeight_Act1),
        nameof(NotEnoughDifficultyConfig.Act4_EventWeight_Act2),
        nameof(NotEnoughDifficultyConfig.Act4_EventWeight_Act3));

    private static readonly PropertyInfo[]? Act4BossProps = LoadPropsOrNull(
        nameof(NotEnoughDifficultyConfig.Act4_BossWeight_Act1),
        nameof(NotEnoughDifficultyConfig.Act4_BossWeight_Act2),
        nameof(NotEnoughDifficultyConfig.Act4_BossWeight_Act3));

    private static readonly PropertyInfo[]? Act5EventProps = LoadPropsOrNull(
        nameof(NotEnoughDifficultyConfig.Act5_EventWeight_Act1),
        nameof(NotEnoughDifficultyConfig.Act5_EventWeight_Act2),
        nameof(NotEnoughDifficultyConfig.Act5_EventWeight_Act3));

    private static readonly PropertyInfo[]? Act5BossProps = LoadPropsOrNull(
        nameof(NotEnoughDifficultyConfig.Act5_BossWeight_Act1),
        nameof(NotEnoughDifficultyConfig.Act5_BossWeight_Act2),
        nameof(NotEnoughDifficultyConfig.Act5_BossWeight_Act3));
    ...
    public static bool BeforeSave(ModConfig __instance)
    {
        ...
        try
        {
            ...
            if (__instance is not NotEnoughDifficultyConfig) return true;
    ...
    private static PropertyInfo[]? LoadPropsOrNull(params string[] names)
    {
        ...
        {
            var arr = names
                .Select(n => typeof(NotEnoughDifficultyConfig).GetProperty(n))
                .ToArray();
